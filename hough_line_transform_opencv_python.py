...
# for the understanding of the math behind hough's transform. You need to be able to do
# some basic mathematics.

# wow! machine learning has to be completed that is; it must be a goal.
